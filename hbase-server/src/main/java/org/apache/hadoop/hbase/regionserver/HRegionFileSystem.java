...
public class HRegionFileSystem {
  ...
  private void insertRegionFilesIntoStoreTracker(List<StoreFileInfo> allFiles, MasterProcedureEnv env,
   ...
   */
  public StoreFileInfo splitStoreFile(RegionInfo hri, String familyName, HStoreFile f, byte[] splitRow,
