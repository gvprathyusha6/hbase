...
public class RestoreSnapshotFromClientSchemaChangeTestBase
  extends RestoreSnapshotFromClientTestBase {
	...
	private static final Logger LOG = LoggerFactory.getLogger(RestoreSnapshotFromClientSchemaChangeTestBase.class);
  ...
  public void testRestoreSchemaChange() throws Exception {
    ...
    CommonFSUtils.logFileSystemState(FileSystem.get(TEST_UTIL.getConfiguration()), TEST_UTIL.getDefaultRootDirPath(), LOG);
