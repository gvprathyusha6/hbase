...
public final class StoreUtils {
  ...
  public static List<StoreFileInfo> toStoreFileInfo(Collection<HStoreFile> storefiles) {
	...
	public static List<HStoreFile> toHStoreFile(List<StoreFileInfo> storeFileInfoList, BloomType bloomType,
			CacheConfig cacheConf) {
		return storeFileInfoList.stream().map(storeFileInfo -> new HStoreFile(storeFileInfo, bloomType, cacheConf))
